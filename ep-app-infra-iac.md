...
**Depende de**: Epic 1, Epic 2 (`environment_id`/`project_id` exportados por `15SOAT-Fase1-database`).
**Repo de código**: [`15SOAT-Fase1-kubernetes`](https://github.com/CandidoRPNeto/15SOAT-Fase1-kubernetes).
...
## Terraform (`15SOAT-Fase1-kubernetes`)
...
- [x] `main.tf` — `dokploy_application.fase1` + `dokploy_domain.fase1`
